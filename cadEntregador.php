...
<form style="padding: 50px" method="post" action="autenticacaoEntregador.php">
        <div class="form-group">
            <center><h3 style="color: white"><b>Cadastro de Entregadores:</b></h3></div></center>
        ...
        <div class="form-group">
            <center><label style="color: white; margin-top: 10px" for="foto">Escolha uma foto de perfil:</label></center>
                <center><input style="width: 50%; color: white" type="file" name="foto" class="form-control-file border">
        </div>

        <div class="form-group">
            <center><label style="color: white" for="cpf">Digite seu CPF:</label></center>
        ...
        <div class="form-group">
            <center><label style="color: white" for="data_nascimento">Digite sua data de nascimento:</label></center>
                <center><input style="width: 50%" type="text" name="data_nascimento" class="form-control" onkeypress="formatar_mascara(this,'##/##/####')" placeholder="Ex.: 00/00/0000" required>
        </div>
