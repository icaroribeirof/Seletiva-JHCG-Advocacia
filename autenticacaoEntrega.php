...
$sql = "insert into entrega (id,nome,data_entrega,endereco_entrega,valor_entrega) values ('$id','$nome','$data_entrega','$endereco_entrega','$valor_entrega')";
...
<center><section>
    ...
    if($linhas == 1){
        ...
        echo "<font color= 'white'>O cadastro NÃO foi realizado!<br>Já existe um pacote em espera neste endereço.</font></br>";
    }
